...
Module Program
    ...
    Sub Main()
        ...
        Program.client.RequestMarketData(12, Program.ER2, Nothing, False, False, Nothing)
        Program.client.RequestMarketData(13, Program.Goog, Nothing, False, False, Nothing)
        Do While True
